                ...
                >
                  <div className="grid grid-cols-10 gap-6">
                    ...
                    <div className="col-span-5">
                      ...
                      {errors.email && (
                        <span className={warningText}>Email is required</span>
                      )}
                    </div>
                    {/* Contact */}
                    <div className="col-span-5">
                      ...
                      />
                      {errors.contact && (
                        <span className={warningText}>Phone is required</span>
                      )}
                    </div>
                    {/* Terms */}
                    <div className="col-span-10">
                      <p>
                        <input
                          ...
                          value=""
                        />{" "}
                        I agree to <Link to="#">terms</Link> and conditions.
                      </p>
                      {errors.agree && (
                        <span className={warningText}>
